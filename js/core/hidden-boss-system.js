...
function hiddenBossProfile(){
  return {
    ...
    desc:"虛構隱藏 Boss。高壓工程數學連擊；每一題的答案都近得離譜。",
    hp:999,
    wrongPenalty:1.85,
    rewardFragments:12,
...
function startHiddenCalculusBoss(){
  ...
  state.activeSession = null;
  state.hiddenBossResult = "";
  $("feedbackArea").innerHTML=`<div class="feedback-card wrong boss-feedback"><div class="feedback-title wrong">∂ Newton Gate 啟動</div><p>10 題工程數學連發開始，請直接作答。</p></div>`;
  state.battleLog.unshift("∂ Newton Gate 啟動：極限微積術師已出現。工程數學連擊開始。");
